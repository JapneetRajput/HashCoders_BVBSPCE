...
//        Log.i(TAG, "onCreate: 1");
        ...
        getSupportActionBar().hide();//STATUS BAR COLOR:
...
//        Log.i(TAG, "onCreate: 2");
        ...
        registerBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String uSertype=positionET.getSelectedItem().toString();
                if(txt_lastName.isEmpty()||txt_username.isEmpty()||txt_firstName.isEmpty()||txt_email.isEmpty() || txt_password1.isEmpty() || txt_password2.isEmpty()){
                    ...
                    if (txt_password1.equals(txt_password2)) {
                        registerUser(txt_firstName, txt_lastName,txt_username,txt_email,txt_password1,uSertype);
                    } else {
    ...
    private void registerUser(String FirstName, String LastName,String Username,String Email, String password, String userType) {
        auth.createUserWithEmailAndPassword(Email,password).addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Toast.makeText(RegisterActivity.this, "Registration successful", Toast.LENGTH_SHORT).show();
                    createDatabaseValues(FirstName,LastName,Username,Email,userType);
    ...
    private void createDatabaseValues(String FirstName, String LastName, String Username, String Email,String userType) {
        user = auth.getCurrentUser();
        dataExtract userr = new dataExtract(FirstName,LastName,Username,Email,userType);
